...
class App extends Component {
  ...
  OnSubmit = () => {
    ...
    fetch('https://sheltered-ridge-62955.herokuapp.com/imageurl', {
      method: 'post',
    ...
    .then(response => response.json())
      .then(response => {
         if (response) {
            fetch('https://sheltered-ridge-62955.herokuapp.com/image', {
              method: 'put',
              headers: {'Content-Type': 'application/json'},
              body: JSON.stringify({
  ...
  render() {
    ...
    return (
       ...
       <ImageLinkForm errorMessage={this.state.errorMessage} OnInputChange={this.OnInputChange} OnSubmit={this.OnSubmit} />
